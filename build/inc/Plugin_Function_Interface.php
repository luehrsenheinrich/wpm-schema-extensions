<?php
/**
 * WpmSchema\Plugin_Function_Interface interface
 *
 * @package wpmschema
 */
...
interface Plugin_Function_Interface {
	/**
	 * Gets plugin function to expose as methods on the Plugin_Functions class instance, accessible through `wp_wpmschema()`.
	 *
